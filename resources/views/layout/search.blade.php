        ...
        <section class="span9 first">
            ...
            <section class="grid-holder features-books">
                ...
                <figure class="span4 slide first">
                    ...
                    <span class="sale-icon">{{ trans('messages.sale') }}</span>
                        @else
            ...
            <div class="blog-footer">
                <div class="pagination">  
                    <ul>
                        ...
                        <li>
                            <a href="{{ $result->url($result->currentPage() - 1) }}">{{ trans('messages.prev') }}</a>
                        </li>
                        @endif
                        ...
                        <li>
                            <a href="{{ $result->url($result->currentPage() + 1) }}">{{ trans('messages.next') }}</a>
                        </li>
                        @endif
                    </ul>
                </div>
                <ul class="product_view">
                    <li>{{ trans('messages.view_as') }}: </li>
                    <li>
                        <a class="grid-view" href="cart.html">{{ trans('messages.grid_view') }}</a>
                    </li>
                    <li>
